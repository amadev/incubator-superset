...
import { NextgisProps, NextgisStylesProps } from './types';
...
const Styles = styled.div<NextgisStylesProps>`
...
export default class Nextgis extends PureComponent<NextgisProps> {
